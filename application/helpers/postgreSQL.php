...
union
select distinct 'C', co.id, co.created_by_id as notify_user_id, cttl.taxon, cttl.language_iso, cttl.preferred_taxon, cttl.default_common_name, co.date_start, co.date_end, co.date_type, snf.public_entered_sref,
