...
<p>This email was sent automatically by the <?php echo $server?> server in response to <?php echo $senderName; ?>
request to recover your password. This process is designed for your protection - only you, the recipient of this email,
can take the next step in the password recovery process.</p>
