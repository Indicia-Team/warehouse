...
<p class="pagination">
	...
	<?php if ($previous_page): ?>
		<a id="prev-<?php echo $id; ?>" href="<?php echo str_replace('{page}', $previous_page, $url) ?>">&laquo;&nbsp;<?php echo Kohana::lang('pagination.previous') ?></a>
	<?php else: ?>
	...
	| <?php if ($next_page): ?>
		<a id="next-<?php echo $id; ?>" href="<?php echo str_replace('{page}', $next_page, $url) ?>"><?php echo Kohana::lang('pagination.next') ?>&nbsp;&raquo;</a>
	<?php else: ?>
