...
<p>This is the Indicia Warehouse, providing administration and configuration of websites
  built using Indicia. In order to gain access to this warehouse you must log on. If you
  do not have an account and need one, please contact the administrator <?php echo $admin_contact; ?>
  who can create one for you.</p>
<p>For more information on Indicia, please see the following links:</p>
<ul>
