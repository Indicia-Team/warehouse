  ...
  foreach ($notifications as $notification) {
    ...
    $theNotificationToInsert = array(
      ...
      'data' => json_encode(array(
          ...
          'auto_generated'=>$notification->auto_generated, 'record_status'=>$notification->record_status, 
          'record_substatus'=>$notification->record_substatus, 'updated_on'=>$notification->updated_on
      )),
