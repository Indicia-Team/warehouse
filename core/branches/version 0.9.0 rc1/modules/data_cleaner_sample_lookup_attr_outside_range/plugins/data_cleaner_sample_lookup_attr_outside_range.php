...
/**
 * Hook into the data cleaner to declare checks for the test of a lookup being outside a range in a sample custom attribute. For example you might want 
 ...
 */
function data_cleaner_sample_lookup_attr_outside_range_data_cleaner_rules() {
  return 
    array(
