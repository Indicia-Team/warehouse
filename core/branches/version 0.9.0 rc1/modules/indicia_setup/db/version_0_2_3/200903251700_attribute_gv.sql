...
FROM occurrence_attributes oa 
	INNER JOIN occurrence_attributes_websites oaw ON (oa.id = oaw.occurrence_attribute_id)
...
FROM location_attributes la 
	INNER JOIN location_attributes_websites law ON (la.id = law.location_attribute_id)
...
FROM sample_attributes sa 
	INNER JOIN sample_attributes_websites saw ON (sa.id = saw.sample_attribute_id)
