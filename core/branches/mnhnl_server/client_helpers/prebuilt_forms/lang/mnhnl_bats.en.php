...
// Locations
	...
	'LANG_LocModTool_Instructions2'=>"Either click on the map (ensuring that the select tool on the map is active) to select the site you wish to modify, or choose from the drop down list. You may then change its name, or modify or add points to define the site. You may drag the highlighted points. To delete a point, place the mouse over the point and press the 'd' or 'Delete' buttons.<br />Selecting an existing site or re-clicking the 'Start a new site' button will remove any new site.",
	...
	'LANG_DE_Instructions2'=>"To choose a site, either click the relevant site on the map (ensuring that the select tool on the map is active) or pick it from the drop down list (then the selected site is highlighted in blue on the map).<br />You may add a new site: click the 'Start a new site' button on the map, select the point draw tool, and draw on the map, clicking on each point. You may drag the highlighted points. To delete a point, place the mouse over the point, and press the 'd' or 'Delete' buttons on the keyboard.<br />Selecting an existing site or re-clicking the 'Start a new site' button will remove any other new site.<br />It is only possible to change the details for a site (e.g. name or boundary) on this form once it has been saved if you are either an Admin user or are the only person to have registered a survey at this site.",
