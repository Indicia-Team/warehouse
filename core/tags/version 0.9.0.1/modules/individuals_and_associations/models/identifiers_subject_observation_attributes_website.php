...
/**
 * Model class for the identifiers_subject_observation_attributes_websites table.
 *
 * @package	Core
 * @subpackage Models
 * @link	http://code.google.com/p/indicia/wiki/DataModel
 */
class Identifiers_subject_observation_attributes_website_Model extends Valid_ORM
{
  protected $has_one = array(
    'identifiers_subject_observation_attribute',
    'website',
  );
  ...
  {
    if ($this->id) {
      return ($this->identifiers_subject_observation_attribute != null ? $this->identifiers_subject_observation_attribute->caption : '');
    } else {
      return 'Identifiers Subject Observation Attribute';
    }    
  }
  ...
  { 
    if (isset($this->submission['fields']['default_value']['value'])) {
      $attr = ORM::factory('identifiers_subject_observation_attribute', $this->submission['fields']['identifiers_subject_observation_attribute_id']['value']);
  ...
  public function __get($column)
  {
    if ($column=='default_value') {
      $attr = ORM::factory('identifiers_subject_observation_attribute', $this->occurrence_attribute_id);
      switch ($attr->data_type) {
        case 'T':
