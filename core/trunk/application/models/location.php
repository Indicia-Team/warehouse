...
class Location_Model extends ORM_Tree {
  ...
  protected $belongs_to = array('created_by'=>'user', 'updated_by'=>'user', 'location_type_id'=>'termlists_term');
  ...
  public function validate(Validation $array, $save = FALSE) {
    ...
    $this->add_sref_rules($array, 'centroid_sref', 'centroid_sref_system', 'centroid_geom');
