...
/**
 * autodetect of the url base path
 * if it dosent work, comment out the 3 next php lines
 * and set the above $config['site_domain'] as described
 */
include(dirname(dirname(__file__)) . '/libraries/Zend_Controller_Request_Http.php');
$zend_http = new Zend_Controller_Request_Http;
$config['site_domain'] = preg_replace("/index\.php.*$/","", $zend_http->getHttpHost() . $zend_http->getBaseUrl());
...
/**
 * setup module
 * you can remove this after setup is done
 */
$config['modules'][] = MODPATH.'indicia_setup';
