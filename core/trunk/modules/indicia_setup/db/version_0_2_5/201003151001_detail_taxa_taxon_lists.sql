...
CREATE OR REPLACE VIEW detail_taxa_taxon_lists AS 
 SELECT ttl.id, ttl.taxon_id, t.taxon, t.authority, tc.taxon AS common, ttl.taxon_list_id, tl.title AS taxon_list, ttl.taxon_meaning_id, ttl.preferred, ttl.description as description_in_list, t.description as general_description, ttl.parent_id, tp.taxon AS parent, ti.path AS image_path, ttl.created_by_id, c.username AS created_by, ttl.updated_by_id, u.username AS updated_by
