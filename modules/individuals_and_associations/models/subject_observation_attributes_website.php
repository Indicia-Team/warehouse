...
/**
 * Model class for the subject_observation_attributes_websites table.
 *
 * @package	Core
 * @subpackage Models
 * @link	http://code.google.com/p/indicia/wiki/DataModel
 */
class Subject_observation_attributes_website_Model extends Valid_ORM
{
  ...
  public function __get($column)
  {
    if ($column=='default_value') {
      $attr = ORM::factory('subject_observation_attribute', $this->occurrence_attribute_id);
      switch ($attr->data_type) {
        case 'T':
