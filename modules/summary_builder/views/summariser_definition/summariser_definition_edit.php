...
if ($existing) {
  ...
  echo data_entry_helper::select(array(
      'label'=>'Survey',
      'fieldname'=>'summariser_definition:survey_id',
      'lookupValues' => $other_data['surveys'],
      'validation'=>'required'
  ));

}

echo "<fieldset><legend>Period</legend>";

echo "<p>Only one period option (weekly) available at the moment.</p>";
echo data_entry_helper::hidden_text(array(
...
echo "</fieldset><fieldset><legend>Data Handling</legend>";
...
echo "</fieldset><fieldset><legend>Estimate Generation</legend>";
...
echo "<p>Only one interpolation option (linear) available at the moment.</p>";
