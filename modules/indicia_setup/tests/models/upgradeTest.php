...
class Model_Upgrade_Test extends PHPUnit_Framework_TestCase {
  ...
  public function testFirstUpgrade() {
    $last_run_script = '';
    $this->model->executeSqlScripts(MODPATH . 'indicia_setup/', 'test_scripts', 'test', $last_run_script);
  ...
  public function testSubsequentUpgrade() {
    ...
    $this->model->executeSqlScripts(MODPATH.'indicia_setup/','test_scripts','test2',$last_run_script);
    // Check the tracking
