-- Add encrypted flag to list_*_attribute_values views.
-- This allows consumers to cheaply detect encrypted values without scanning payload prefixes.
