...
-- Expose the encrypt column in list views used by warehouse UI forms.
DROP VIEW IF EXISTS list_survey_attributes;
...
DROP VIEW IF EXISTS list_taxa_taxon_list_attributes;
...
DROP VIEW IF EXISTS list_termlists_term_attributes;
...
DROP VIEW IF EXISTS list_person_attributes;
