...
SELECT l.id, l.title, l.code, l.version, l.url_readable, l.url_legal, lw.website_id, l.open
FROM licences l
JOIN licences_websites lw ON l.id = lw.licence_id AND lw.deleted = false
WHERE l.deleted=false;

CREATE OR REPLACE VIEW detail_licences AS
SELECT l.id, l.title, l.code, l.description, l.version, l.url_readable, l.url_legal, lw.website_id, l.open
FROM licences l
