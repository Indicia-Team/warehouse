...
?>
<form action="<?php echo url::site(); ?>verification_rule/save" method="post" id="entry-form">
  <fieldset>
    <legend>Verification rule details<?php echo $metadata; ?></legend>
    <?php
    ...
    echo data_entry_helper::text_input(array(
      ...
      'helpText' => 'When this verification rule file was imported, this identifies the name of the file it was imported from',
    ));
    echo data_entry_helper::text_input(array(
