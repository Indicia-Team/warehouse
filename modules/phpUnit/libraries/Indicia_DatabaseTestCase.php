 ...
 *
 * https://phpunit.de/manual/6.5/en/database.html#database.tip-use-your-own-abstract-database-testcase
 */
abstract class Indicia_DatabaseTestCase extends DbUTestCase {
  ...
  public function getDataSet() {
    return new Indicia_ArrayDataSet([]);
  }
  ...
  /**
   * Override the function to create the database connection.
   *
   * Use My_DB_DefaultDatabaseConnection.
   */
