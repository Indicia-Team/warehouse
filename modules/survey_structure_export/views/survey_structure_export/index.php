<p>This tool allows you to generate a piece of text which describes the structure of the custom attributes associated with
...
echo data_entry_helper::textarea([
  ...
  'helpText' => 'Copy this text to the clipboard. You can then paste it into another survey on this or another ' .
    'warehouse to clone the attributes.',
  'default' => $export,
]);
?>
<form id="survey-structure-import" action="<?php echo url::site(); ?>survey_structure_export/save" method="post" id="entry-form"">
  <fieldset>
    <?php
