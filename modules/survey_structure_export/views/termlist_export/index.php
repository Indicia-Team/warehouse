<p>This tool allows you to generate a piece of text which describes the terms in a termlist. The text generated can
...
?>
<form id="termlist_structure_export" action="<?php echo url::site(); ?>termlist_export/save" method="post" id="entry-form"">
  <fieldset>
    <?php
    echo data_entry_helper::textarea(array(
