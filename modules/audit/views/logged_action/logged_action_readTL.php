 ...
 * @linkhttps://github.com/indicia-team/warehouse
 */
...
<table class="table">
  ...
  <tbody>
    <tr>
      <th for="row">PostgreSQL transaction ID</th>
      <td>$search[transaction_id]</td>
    </tr>
    <tr>
      <th for="row">Table</th>
      <td>$search[search_table_name]</td>
    </tr>
    <tr>
      <th for="row">ID</th>
      <td>$search[search_key]</td>
    </tr>
  </tbody>
</table>
