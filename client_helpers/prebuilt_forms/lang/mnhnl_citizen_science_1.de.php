...
$custom_terms = array(
  ...
  'search'=>'Suchen',
  'search for place on map'=>'Standort auf der Karte suchen',
  'surname'=>'Nachname',
  ...
  // Tab instructions
  'about you tab instructions'=>'<strong>Wer ich bin</strong><br/>Sagen Sie uns bitte wer Sie sind. Dies k�nnte wichtig sein, damit wir Sie kontaktieren k�nnen, falls ihre Beobachtung besonders interessant ist.',
  ...
  'place tab instructions'=>'<strong>Wo es war</strong><br/>Suchen Sie auf der Karte den Ort, wo Sie die Blume gesehen haben so genau wie m�glich. Wenn Sie die Koordinaten kennen, k�nnen Sie diese auch direkt eingeben.',
  'other tab instructions'=>'<strong>Aner Informationen</strong><br/>Sagen Sie uns bitte wann Sie die Blume gesehen haben, wie viele es ungef�hr waren und wenn n�tig weitere Bemerkungen.',
